...
comp-gas-canister-ui-holding-tank-status = 儲存槽狀態
comp-gas-canister-ui-holding-tank-label = 油箱標籤：
comp-gas-canister-ui-holding-tank-label-empty = Empty
comp-gas-canister-ui-holding-tank-pressure = 儲槽壓力：
comp-gas-canister-ui-holding-tank-eject = Eject
comp-gas-canister-ui-release-valve-status = 洩壓閥狀態
comp-gas-canister-ui-release-pressure = 釋放壓力 (kPa)：
comp-gas-canister-ui-release-valve = 洩壓閥：
comp-gas-canister-ui-release-valve-open = Open
comp-gas-canister-ui-release-valve-close = 關閉
