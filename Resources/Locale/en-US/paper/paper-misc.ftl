...
book-text-agrichemkit-manual =
    感謝您選擇這款適合全齡層的 NanoTrasen「農業化學真有趣！」化學實驗套組，這是 2468 年最棒的寓教於樂玩具！請準備好探索自古以來人們將魚與玉米種子一同埋入土壤以來，農業領域最重大的創新成果。
    ...
    一小瓶 EZ Nutrient 就能取代那堆原本會被你用來堆肥、用以維持植物強健生長的大量農產品。而那些被你拿去堆肥的作物，正是你未能從中獲利的收成，所以請讓 EZ Nutrient 持續供應吧。
    
    第二項實驗：氨與二乙胺
    將 3 份氫與 1 份氮混合即可製成氨。這對狀態欠佳的作物來說，是份健康且營養豐富的養分補給。 
    但若你想在當地由 NanoTrasen 贊助的縣級博覽會上給評審留下深刻印象，就必須在氨中加入等量的乙醇。
    這樣便會混合成二乙胺——一種能讓植物生長更快且壽命更長的奇蹟肥料！多虧了二乙胺，你能讓心愛的作物陪伴你更久。
    
    第三項實驗：不穩定致突變劑
    當你準備向所有人證明自己是站上最偉大的植物學家時，你需要調配一些不穩定致突變劑，並祈禱一切順利。儘管名稱聽起來令人害怕，但不穩定致突變劑用於植物時完全安全，但切勿自己飲用這種色澤誘人的綠色化學物質。
    
    將鐳、磷和氯以等量混合，即可製成一罐鮮綠色的不穩定突變劑——這是既安全又有趣，能讓你的農場發揮最大效益的方法。這套套件讓你能製作的 15u 不穩定突變劑，或許正是你邁向農業化學界明星之路的起點！
    不穩定致突變劑對植物生命可能產生多種多樣的效果，包括徹底改變各類生長參數、產出富含有益藥用成分的農產品、培育出在黑暗中發光的植物，甚至創造出全新的物種。
    
    每株植物對不穩定致突變劑的反應各不相同，因此建議您對多種作物使用小劑量，並嘗試將各作物中最優的性狀進行雜交。若對單一植物施用多劑量，可能會疊加多種變化，使您更難篩選出理想的性狀。
    不穩定致突變劑用作肥料時完全安全，而 NanoTrasen 對於使用過程中可能偶然發生的作物死亡、水費過高、新獲得意識的植物提出存在主義問題，或是被植物勒死的農工等情況，概不負責。
    請勿飲用不穩定致突變劑。接觸後請徹底洗手。 若您在 24 小時內凝視「不穩定致突變劑」超過 30 分鐘，請立即沖洗眼睛。請儲存於 293–295K 的暗室中。請勿於公司假日使用。若您開始聽到聲音指示您飲用「不穩定致突變劑」，請聯繫您的醫師、人事主管或驅魔師。
