...
steal-target-groups-captain-id-card = 隊長證
...
steal-target-groups-weapon-energy-shot-gun = 能量霰彈槍
# Thief Collection
...
steal-target-groups-medical-tech-fab-circuitboard = 醫療用科技製造機主板
steal-target-groups-clothing-headset-alt-medical = 首席醫療官的包耳式耳機
...
steal-target-groups-salvage-expeditions-computer-circuitboard = 打撈探險隊的電腦主板
steal-target-groups-cargo-shuttle-console-circuitboard = 貨運穿梭機控制台面板
steal-target-groups-clothing-eyes-hud-beer = 酒後眼朦朧
