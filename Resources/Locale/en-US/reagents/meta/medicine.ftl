...
reagent-desc-cryoxadone = 一種低溫化學物質。可用於治療窒息和失血，但僅在溫度低於 213K 時才有效。小劑量使用時，可治療並使植物恢復生機。無論患者是生是死，此藥皆有效。
reagent-name-doxarubixadone = 多沙魯比克薩酮 (doxarubixadone)
reagent-desc-doxarubixadone = 一種低溫化學藥劑。能修復因危險氣體和化學物質所造成的細胞損傷。無論患者是生是死，皆能發揮作用。
...
# Frontier: no caps
reagent-name-polypyrylium-oligomers = 聚吡啶低聚物 polypyrylium oligomers
...
reagent-desc-ambuzol = 一種經過高度工程設計的物質，能夠阻止殭屍感染的惡化。
...
reagent-desc-cognizine = 一種神秘化學物質，能夠使任何無知覺的生物獲得知覺。已知會引發難以預料的行为，使用時請謹慎。
...
reagent-desc-lacerinol = 一種化學性質相當穩定的物質，能將膠原蛋白的合成提升至驚人的程度，從而促進傷口癒合。
...
reagent-desc-necrosol = 一種低溫化學物質。能治癒大多數有機損傷，堪稱真正的萬靈丹。小劑量使用時，可治療並使植物恢復生機。無論患者是生是死，皆能發揮功效。
