...
# Frontier: no "at Med"
reagent-desc-alien-brain-hemorrhage = 你或許該去檢查一下。
...
reagent-desc-eggnog = 口感濃郁、甜美，帶點酒香。完全是蛋酒風味。
...
reagent-name-kira-special = 基拉特輯 Kira special
reagent-desc-kira-special = 那個被大家誤認為是女生的傢伙萬歲。笨蛋！
...
reagent-name-neurotoxin = 神經毒素 neurotoxin
reagent-desc-neurotoxin = 一種強效的神經毒素，會使受試者陷入類似死亡的狀態。
...
reagent-name-budget-insuls = 經濟型隔熱材料 budget insuls
...
reagent-name-bacchus-blessing = 巴克斯的祝福 Bacchus' blessing
