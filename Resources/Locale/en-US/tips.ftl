...
tips-dataset-5 = artefact 能夠為某些觸發節點獲得永久效果，包括轉變為對講機或極其高效的發電機。
...
tips-dataset-11 = 裝好誘餌的捕鼠夾在對付各類低質量小怪時效果極佳——包括「老鼠僕從」。
...
tips-dataset-18 = 運行「奇點」時，請務必定期檢查其運作狀況。若遭人破壞，可能會危及整個空間站的安全。
...
tips-dataset-31 = 身為「叛徒」，你可以使用該組織的加密金鑰，透過安全通道與任何已購買此金鑰的其他叛徒進行通訊。
tips-dataset-32 = 身為一名叛徒，若能滲透安全或工程等重要通訊管道，便能獲取寶貴的情資。請注意，這是一把雙刃劍——安全部門同樣也能滲透犯罪集團的通訊！
tips-dataset-33 = 身為「叛徒」，這套黑手黨工具箱的功能極為多元。只需花費 2 顆電晶體，你就能獲得一套完整的工具，以應對緊急狀況，其中包括隔熱戰鬥手套和黑手黨防毒面具。
...
tips-dataset-38 = 身為一名「叛徒」，等離子氣體是製造混亂的絕佳手段。它既能被點燃，使某個區域變得極度不宜居住，也能對吸入者造成毒性傷害。
tips-dataset-39 = 身為「叛徒」，脫水的鯉魚用來屠殺大批人群相當有用。只要在讓它恢復水分之前先拍一拍它，它就能成為絕佳的牽制手段。
tips-dataset-40 = 身為一名「叛徒」，你試過將血漿注入電池裡嗎？如果是除顫器，一使用就會爆炸，不僅會傷害使用者，還會傷害病患！
...
tips-dataset-52 = 身為一名打撈專家，不妨考慮與貨運技術人員合作。他們可以為你訂購各式各樣實用的物品，包括一些透過其他管道可能難以取得的物品，例如雷射槍和穿梭機建造材料。
tips-dataset-53 = 身為貨運技術員，不妨向科學部門申請一台「瑞普利 APLU」。若搭配液壓夾具使用，便能更輕鬆地抓取燃料箱等重要的維修物件，並迅速完成配送任務。
tips-dataset-54 = 身為貨運技術員，請盡量確保材料庫存充足。這些材料對科學家和站務工程師來說極為實用，讓他們能隨時取用。
tips-dataset-55 = 身為貨運技術員，若手頭有閒錢，不妨試試賭博！有時你甚至能賺到比最初投入還多的錢。
tips-dataset-56 = 身為一名貨艙技術員，請記住：在緊急情況下，你可以訂購槍枝！這額外的火力，往往就是決定你與同袍生死的關鍵。
...
tips-dataset-73 = 身為一名工程師，在設定奇點時務必仔細確認。奇點一旦失控，比你想像中還要容易！
tips-dataset-74 = 身為一名工程師，你可以使用等離子玻璃來加固特定區域並阻隔輻射。鈾玻璃同樣可用於阻隔輻射。
tips-dataset-75 = 身為船長，你是太空站上最受重視的目標之一。無論是叛亂分子、核武特工，還是企圖搶走你那把獨一無二的雷射手槍甚至奪走你性命的叛徒，這些都是你必須提防的威脅。
...
tips-dataset-78 = 身為船長，請盡量保持活躍並在空間站內巡邏。雖然待在指揮橋上可能很誘人，但這樣只會讓自己成為更顯眼的目标！
tips-dataset-79 = 身為一名科學家，當掃描器處於冷卻狀態時，你可以對文物進行各種隨機嘗試，藉此大幅加快點數萃取的進程。
tips-dataset-80 = 身為一名科學家，你可以利用升級版的機器來提升其效能。這能讓某些機器的表現大幅提升；如果你升級了「礦石處理機」，回收部門一定會對你感激不盡！
tips-dataset-81 = 身為一名科學家，你可以利用正子腦和機體來製造機械人，它們與新加入的船員一樣有用。
...
tips-dataset-85 = 身為一名醫師，請記住，若您遺失了 PDA，仍可使用健康分析儀。不過它內建電池，若您覺得電量消耗過快，大可請科學家為您列印一顆更棒的電池！
tips-dataset-86 = 身為一名化學家，一旦你已經合成了所有需要的物質，就別害怕再多合成一些古怪的試劑。你試過脫氧麻黃鹼或甘草酚嗎？
tips-dataset-87 = 身為醫師、化學家或首席醫療官，您可以使用氯醛水合物對不聽從指示的病患進行非致命性的鎮靜處理。
...
tips-dataset-130 = 殭屍對熱傷害極為脆弱，因此焊接工具和雷射槍對付它們時極為有效。
...
tips-dataset-136 = 如果你被困在帶電的門後面，請關閉自動門控制系統（APC），或將你的身分證扔向門上，以免遭到電擊！
...
tips-dataset-139 = 使用非法植入器後，請務必用肥皂或濕布將其清潔乾淨！偵探可以掃描用過的植入器以尋找能作為罪證的 DNA 證據，但如果植入器已被徹底擦拭乾淨，他們就無法找到任何證據。
